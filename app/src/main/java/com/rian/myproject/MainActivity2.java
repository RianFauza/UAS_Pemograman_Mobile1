...
public class MainActivity2 extends AppCompatActivity implements UtilsAwv.Listener {
    ...
    public void openQuitDialog() {
        ...
        alert = new androidx.appcompat.app.AlertDialog.Builder(MainActivity2.this);
